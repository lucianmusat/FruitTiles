...
public class MainMenu extends Activity {
	...
	Button imageButton,aboutButton,highscoreButton;
	...
	public void addListenerOnButton() {
		...
		imageButton = (Button) findViewById(R.id.newGame);	
		...
		imageButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				imageButton.setBackgroundResource(R.drawable.newgame_pressed);
				imageButton.setHeight(65);
				imageButton.setWidth(390);
		        ...
		        handler.postDelayed(new Runnable() {
		            @Override
		            public void run() {
						Intent k = new Intent(MainMenu.this, TwoByTwo.class);
						startActivity(k);
		            }
		        }, 300);	
